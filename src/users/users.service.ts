...
export class UsersService {
    ...
    async updateUser(
        ...
        const updatedUser = await this.findUser(email);
            ...
            if(musicTags)
            {
                updatedUser.musicTags=musicTags;
            }
            if(follows.bands)
            {
                updatedUser.follows.bands=follows.bands;
            }
            if(follows.musicians)
            {
                updatedUser.follows.musicians=follows.musicians;
            }
            if(follows.bars)
            {
                updatedUser.follows.bars=follows.bars;
            }
            if(locations)
            {
                updatedUser.locations=locations;
            }
